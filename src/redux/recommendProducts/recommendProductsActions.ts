...
export const FETCH_RECOMMEND_PRODUCTS_START = 'FETCH_RECOMMEND_PRODUCTS_STARTS'
...
export const fetchDataCreator = (): ThunkAction<void, RootState, unknown, RecommendProductsAction> => async (dispatch, getState) => {
